...
DROP DATABASE IF EXISTS `agenciabancaria3si30março`;
...
-- Copiando dados para a tabela agenciabancaria3si30março.cliente: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela agenciabancaria3si30março.conta: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `conta` DISABLE KEYS */;
/*!40000 ALTER TABLE `conta` ENABLE KEYS */;

-- Copiando estrutura para tabela agenciabancaria3si30março.contasvinculadas
DROP TABLE IF EXISTS `contasvinculadas`;
...
-- Copiando dados para a tabela agenciabancaria3si30março.contasvinculadas: ~0 rows (aproximadamente)
